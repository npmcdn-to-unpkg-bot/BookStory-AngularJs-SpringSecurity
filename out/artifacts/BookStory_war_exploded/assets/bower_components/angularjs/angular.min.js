...
(function (N, W, u) {
    ...
    function Oc(b, a) {
        return zb(b, "$" + (a || "ngController") + "com.Controller")
    }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, w, p, A, r, M, O, J) {
            ...
            function V(a, b, c, d, e) {
                ...
                return function (b, c, d) {
                    ...
                    if (h)for (var k in h)d.data("$" + k + "com.Controller", h[k].instance);
                    V.$$addScopeInfo(d, b);
                    c && c(d, b);
                    f && f(b, d, d, e);
                    return d
            ...
            function C(a, b, d, e, f, g, h, k, m) {
                ...
                function t(a, b, c, d) {
                    ...
                    if (H(b)) {
                        ...
                        e || (d = "$" + b + "com.Controller", e = g ? c.inheritedData(d) : c.data(d));
                ...
                function L(a, c, e, f, g, l) {
                    ...
                    if (A) {
                        ...
                        for (s in A) {
                            J = A[s];
                            var C = J();
                            C !== J.instance && (J.instance = C, ja.data("$" + s + "com.Controller", C), J === M && (l.$$destroyBindings(), l.$$destroyBindings = Y(c, f, C, p, n)))
                        }
                    }
                    s = 0;
